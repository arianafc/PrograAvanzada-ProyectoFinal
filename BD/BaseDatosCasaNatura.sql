...
BEGIN
    ...
    IF @IdAnimal IS NULL
    BEGIN
        RAISERROR('No se encontr� el apadrinamiento especificado', 16, 1);
        RETURN;
    END;
...
BEGIN
    ...
    -- Actualiza la contrase�a encriptada
    UPDATE USUARIOS_TB
...
('Milo', 4, '20230318', NULL, '20220228', 2, 4, '/Imagenes/4.jpg', 'Convaleciente por accidente.', 'Atenci�n m�dica semanal'),
